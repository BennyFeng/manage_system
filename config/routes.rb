Rails.application.routes.draw do
  ...
  get '/users/showdoc', to: 'users#showdoc'
  get '/users/showance', to: 'users#showance'
  get '/users/showlag', to: 'users#showlag'
  get '/users/showatt', to: 'users#showatt'
  get '/users/newpwd', to: 'users#newpwd'
  post '/users/updatepwd', to: 'users#updatepwd'
  get '/managements/newpwd', to: 'managements#newpwd'
  post '/managements/updatepwd', to: 'managements#updatepwd'
  get '/managements/authdoc', to: 'managements#authdoc'
  post '/managements/createadmin', to: 'managements#createadmin'
  get '/managements/uauthdoc', to: 'managements#uauthdoc'
